      ...
      <div style={{border:'1px solid gray'}} className="card lg:card-side bg-base-100 shadow-xl lg:w-full w-96 mb-8 lg:h-[600px]">
        ...
        <div className="lg:pl-6 lg:w-1/2 w-96">
         ...
         {bookName}
          ...
          <button  onClick={handleRead}  className=" border bg-white rounded-md p-2 hover:bg-gray-300  ">Read</button>
          <button onClick={handleWishList} className=" border-none   rounded-md p-2 bg-[#50B1C9] text-white ">Wishlist</button>
