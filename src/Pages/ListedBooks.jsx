...
const ListedBooks = () => {
  return (
    <div>
      ...
      <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap dark:bg-gray-100 dark:text-gray-800 mt-3">
        <a
        ...
        <div className="card md:card-side border p-4 border-red-500">
          ...
          <div className="pl-8 mt-2">
            ...
            <div className="mt-4 flex gap-8">
              <h1 className="flex gap-2 playfair">
                {" "}
                <CgProfile className="text-lg mt-1" /> Publisher : Scribner
              </h1>
              <h1 className="flex gap-2 playfair">
                {" "}
                <IoBookOutline className="mt-1" /> Page : 192
              </h1>
            </div>
