    ...
    <div>
      <div className="mt-[100px]">
        <div
          ...
          className="card lg:card-side bg-base-100 shadow-xl lg:w-full w-96 mb-8 lg:h-[600px]"
        >
          ...
          <div className="lg:pl-6 lg:w-1/2 w-96">
            <h1 className="playfair text-xl font-semibold ">{bookName}</h1>
            ...
            <p className="mt-4 ">
              ...
              <span className="playfair text-sm text-gray-600">{review}</span>
            </p>
            ...
            <div className="mt-4 flex gap-4 mb-4">
              <button className=" border bg-white rounded-md p-2 hover:bg-gray-300  ">
                Read
              </button>
              <button className=" border-none   rounded-md p-2 bg-[#50B1C9] text-white ">
                Wishlist
              </button>
            </div>
          </div>
...
export default ViewDetailsWishList;
