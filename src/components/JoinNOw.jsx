const JoinNOw = () => {
  return (
    <div>
      <div className="flex h-[900px] rounded-xl items-center justify-center bg-[#8EA7E9]/20 p-6 md:p-0">
        <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
          ...
          <div className="relative hidden h-full items-center justify-center bg-[#8EA7E9] md:flex md:w-[60%] lg:w-[40%]">
            ...
            <div className="space-y-2 text-center">
              <h2 className="text-3xl playfair  font-medium text-white/80 ">
                Welcome Back Book Vive
              </h2>
              <p className="animate-pulse text-sm text-white/80">
          ...
          <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
            ...
            <form className="flex  w-full flex-col items-center justify-center gap-4">
              ...
              <label htmlFor="my_modal_6" className="btn w-[370px] bg-[#8EA7E9] text-white">
                Submit
              </label>
              ...
              <div className="modal" role="dialog">
                <div className="modal-box">
                  ...
                  <p className=" py-4">
                   Now you are a member of book vibe
                  </p>
